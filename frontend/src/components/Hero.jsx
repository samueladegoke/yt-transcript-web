...
// Brand SVG logos — EXACT official @iconify-json/logos package (NO modifications)
const BRAND_SVGS = {
  // Google — 4-color official (Google brand colors)
